...
const TestimonialCard: React.FC<{ quote: string; name: string; title: string; initials: string; }> = ({ quote, name, title, initials }) => (
    <div className="bg-dark-card p-6 rounded-2xl border border-dark-border">
        ...
        <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-brand-purple to-brand-pink flex items-center justify-center font-bold text-white">
                {initials}
            </div>
            <div>
